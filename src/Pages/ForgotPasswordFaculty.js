...
function ForgotPasswordFaculty() {
    ...
    const handleSubmit = (e) => {
        ...
        if(username.length > 0){
            ...
            var config = {
                method: 'get',
                url: 'http://localhost:3000/faculty/getotp',
                data : data,
            };
            Axios(config)
            .then((response) => {
    ...
    if(redirect_state){
        return <Redirect to="/Faculty/ResetPassword" />
    }
    else if(error_state){
                ...
                <div className="forgot-container">
                    ...
                    <div className="input-container">
                        <form className="forgot-password-form" onSubmit={handleSubmit}>
                                ...
                                <p className="forgot-password-message">Enter your Faculty ID and we will send an OTP to your registered email</p>
